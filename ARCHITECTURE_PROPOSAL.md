...
| PDF | XeLaTeX در TeX Live 2023 + XePersian 24.8 | حروف‌چینی فارسی/انگلیسی، فونت، پاورقی، bookmark و کنترل کتابی؛ ۲۲ صفحهٔ corrective sample رندر شد |
| منابع | BibTeX برای دادهٔ ممیزی + نشانگر/کتاب‌نامهٔ عددی QMD | ردیابی ۱۱/۱۱ کلید و نمایش مشترک خوانا بدون author–date یا URL خام |
...
| آزمون وب | Playwright 1.61.1 + axe 4.12.1؛ Chromium 149 و Firefox ESR 140.12 | viewport، bidi، تعامل و accessibility؛ ماتریس خودکار L1 عبور کرده، اما human web audit طبق تصمیم کاربر به Codex واگذار شده است |
...
| Phase 4C | M07–M08 | review روابط/شکل‌های انتقال قدرت |
| Phase 4D | M09–M10 + backmatter | پوشش ۱۰۰٪ و media manifest کامل |
