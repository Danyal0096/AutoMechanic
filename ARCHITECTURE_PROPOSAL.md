...
| M02 | چرخهٔ چهارزمانه، حجم‌ها، فازبندی، وانکل | sequence diagram/مقطع معتبر | Critical |
| M03 | OHV/OHC، valve timing، آب‌بندی سرسیلندر/رینگ | مقطع/نمودار زمان‌بندی | Critical |
| M04 | مکانیزم لنگ، مسیر بار، گوه روغن، انبساط | مقطع معتبر + overlay ساده | Critical |
...
| M07 | مسیر دنده، کلاچ دوحالت، جهت چرخش | state/force-flow diagram | Critical |
| M08 | دیفرانسیل، مبدل، سیاره‌ای، DCT، CVT | animation وب + فریم/توالی PDF | Critical |
